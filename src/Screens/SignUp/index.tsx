...
// syltes
 ...
 function SignUp() {
    ...
    async function login () {
        ...
        const response = await axios.post(`${baseApiLogin}/users/`, data)

        if(response.data){
            if(response.data.message){
                Alert.alert('Opp!','Usuario existente')
            } else {
            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}  >
                    <View style={styles.inner}>
                        ...
                        {/* <Text style={styles.textFeet}>Novo por aqui? Inscreva-se agora</Text> */}
